...
2. Chay lenh sau de xem Chat ID cua ban:
   ```powershell
   C:\Users\Admin\AppData\Local\Programs\Python\Python314\python.exe TradingTeam\scripts\get_telegram_chat_id.py "8245864273:AAE9xuMtXpzDllI8QxGhH-POJ8SdS620SUU"
   ```

## Lenh chay chu ky tu dong (Moi 4h)
Lenh nay se chay toan bo quy trinh: Lay gia -> Quet Swing -> Gui Telegram.
```powershell
C:\Users\Admin\AppData\Local\Programs\Python\Python314\python.exe TradingTeam\scripts\run_automated_scans.py --telegram-token "8245864273:AAE9xuMtXpzDllI8QxGhH-POJ8SdS620SUU" --telegram-chat-id <YOUR_CHAT_ID> --loop
```

## Lenh chay tuc thi (On-demand)
```powershell
C:\Users\Admin\AppData\Local\Programs\Python\Python314\python.exe TradingTeam\scripts\run_automated_scans.py --telegram-token "8245864273:AAE9xuMtXpzDllI8QxGhH-POJ8SdS620SUU" --telegram-chat-id <YOUR_CHAT_ID>
```
...
## Ghi chu van hanh
- Trang thai cac tin nhan da gui duoc luu tai: `TradingTeam/Agent_2_SwingAgent/Runtime/sent_alerts.json`.
