...
## Script
- `TradingTeam/scripts/scan_h4_swing_setups.py`

## Lenh chay mac dinh
```powershell
python TradingTeam\scripts\scan_h4_swing_setups.py
```

## Lenh chay market cu the
```powershell
python TradingTeam\scripts\scan_h4_swing_setups.py --markets crypto
```

## Dau ra
- summary:
  - `TradingTeam/Agent_2_SwingAgent/Logs/latest_h4_scan_summary.json`
  - `TradingTeam/Agent_2_SwingAgent/Logs/_scanner_runs.jsonl`
- candidate logs:
  - `TradingTeam/Agent_2_SwingAgent/Logs/crypto/*.jsonl`
  - `TradingTeam/Agent_2_SwingAgent/Logs/cfd/*.jsonl`
