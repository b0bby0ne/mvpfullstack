//+------------------------------------------------------------------+
//|                  CCBSN_Trading_Zone_Controller_v3.mq5 v3.2.5     |
//|      Pine v3.1.3 parity + read-only external monitor status      |
//+------------------------------------------------------------------+
#property strict
#property copyright "TradingTeam"
#property version   "3.250"
...
input string InpTextPanelTitle      = "CCBSN CONTROLLER v3.2.5";
...
input string InpMonitorStatusFile      = "CCBSN\\controller_status_v1.json";
...
const string InpCsvFileName         = "CCBSN_Trading_Zone_Events_v3_2_5.csv";
const bool InpKeepObjectsOnRemove   = false;
const ulong TICKET_STORAGE_BASE     = 1000000000;
const string MONITOR_SCHEMA_VERSION = "ccbsn-monitor-status.v1";

const ENUM_TIMEFRAMES DECISION_TIMEFRAME = PERIOD_M15;
const string POLICY_ID      = "ccbsn-m15-pine-v3-controller";
const string POLICY_VERSION = "3.2.5-mt5-read-only-monitor-status";
...
void ReportPerformanceMetrics(const string context,
                              const bool forceReport)
  {
   ...
   PrintFormat("PERF V3.2.5 | context=%s elapsed=%.1fs | ticks=%I64u timers=%I64u | policy=%I64u/%I64u | control_fast=%I64u idle=%I64u | visual=%I64u dashboard=%I64u snapshots=%I64u redraw=%I64u ema=%I64u/%I64u monitor=%I64u/%I64u",
   ...
   PrintFormat("PERF LATENCY V3.2.5 | policy_avg=%.1fus max=%I64uus | control_avg=%.1fus max=%I64uus | visual_avg=%.1fus max=%I64uus",
...
string BuildMonitorStatusJson(const ulong sequence)
  {
   ...
   json += "  \"last_m15_decision_server\": " + JsonString(decisionTime) + ",\n";
   json += "  \"last_m15_decision_age_seconds\": " + IntegerToString(decisionAgeSeconds) + ",\n";
