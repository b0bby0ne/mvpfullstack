//+------------------------------------------------------------------+
//|                  CCBSN_Trading_Zone_Controller_v3.mq5 v3.2.1     |
//|       Pine v3.1.3 parity + scheduler performance telemetry       |
//+------------------------------------------------------------------+
#property strict
...
input string InpTextPanelTitle      = "CCBSN CONTROLLER v3.2.1";
...
const string InpCsvFileName         = "CCBSN_Trading_Zone_Events_v3_2_1.csv";
...
const string POLICY_VERSION = "3.2.1-mt5-performance-telemetry";
...
void ReportPerformanceMetrics(const string context,
                              const bool forceReport)
  {
   ...
   PrintFormat("PERF V3.2.1 | context=%s elapsed=%.1fs | ticks=%I64u timers=%I64u | policy=%I64u/%I64u | control_fast=%I64u idle=%I64u | visual=%I64u dashboard=%I64u snapshots=%I64u redraw=%I64u ema=%I64u/%I64u",
   ...
   PrintFormat("PERF LATENCY V3.2.1 | policy_avg=%.1fus max=%I64uus | control_avg=%.1fus max=%I64uus | visual_avg=%.1fus max=%I64uus",
