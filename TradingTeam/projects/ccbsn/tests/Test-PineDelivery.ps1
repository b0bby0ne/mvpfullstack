...
$sharedDefaults = @(
    ...
    @{ Name = 'Upside maximum'; Pine = 'upsideMaxAboveEma\s*=\s*input\.float\(20\.0,'; Mt5 = 'Inp(?:UpsideMaxAboveEMAPrice|MaxAboveEMAPrice)\s*=\s*20\.0;' },
    @{ Name = 'Upside confirm bars'; Pine = 'upsideConfirmBars\s*=\s*input\.int\(2,'; Mt5 = 'Inp(?:UpsideConfirmBars|EnableConfirmBars)\s*=\s*2;' },
    @{ Name = 'Consecutive red'; Pine = 'consecutiveRedBars\s*=\s*input\.int\(3,'; Mt5 = 'InpConsecutiveRedBars\s*=\s*3;' },
    @{ Name = 'Upside risk lock'; Pine = 'upsideRiskLockBars\s*=\s*input\.int\(2,'; Mt5 = 'Inp(?:UpsideRiskLockBars|RiskLockBars)\s*=\s*2;' },
