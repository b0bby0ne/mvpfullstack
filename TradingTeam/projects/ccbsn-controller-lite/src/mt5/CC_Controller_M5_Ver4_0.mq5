//+------------------------------------------------------------------+
//|                    CC_Controller_M5_Ver4_0.mq5                    |
//|       CCBSN cycle control + supervised M5 market policy          |
//+------------------------------------------------------------------+
#property strict
#property copyright "TradingTeam"
#property version   "4.000"
#property description "CC Controller M5 Ver4.0 - supervised fail-closed cycle control"
#property description "ATR M5 policy, startup barrier, dashboard, checklist and New Cycle handshake."
...
input string InpTextPanelTitle      = "CC CONTROLLER M5 | VER4.0";
...
input string InpMonitorStatusFile      = "CCBSN\\cc_controller_m5_ver4_status.json";
...
const int SUPERVISOR_STARTUP_HOLD_MILLISECONDS = 70000;
const string InpCsvFileName         = "CC_Controller_M5_Ver4_0_Events.csv";
...
const string POLICY_ID      = "cc-controller-m5-ver4";
const string POLICY_VERSION = "4.0.0-supervisor";
...
void ReportPerformanceMetrics(const string context,
                              const bool forceReport)
  {
   ...
   PrintFormat("PERF CC CONTROLLER M5 VER4.0 | context=%s elapsed=%.1fs | ticks=%I64u timers=%I64u | policy=%I64u/%I64u | control_fast=%I64u idle=%I64u | visual=%I64u dashboard=%I64u snapshots=%I64u redraw=%I64u ema=%I64u/%I64u monitor=%I64u/%I64u",
   ...
   PrintFormat("PERF LATENCY CC CONTROLLER M5 VER4.0 | policy_avg=%.1fus max=%I64uus | control_avg=%.1fus max=%I64uus | visual_avg=%.1fus max=%I64uus",
      ...
      if(command == CCBSN_COMMAND_NEW_CYCLE_OFF &&
         g_startupCycleBarrierActive)
        {
         ...
         g_startupPolicyHoldUntilTick = GetTickCount64() +
                                        SUPERVISOR_STARTUP_HOLD_MILLISECONDS;
   ...
   if(!g_configurationValid)
     {
      ...
      g_objectPrefix = "CC_CONTROLLER_M5_V4." + IntegerToString(ChartID()) + ".";
      EventSetMillisecondTimer(InpTimerMilliseconds);
      Comment("CC Controller M5 Ver4.0 CONFIG SAFE MODE\n",
