...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--logs-dir-agent1", default="TradingTeam/agents/Agent_1_PriceAgent/Logs/vn_stock")
    parser.add_argument("--logs-dir-agent2", default="TradingTeam/agents/Agent_2_SwingAgent/Logs")
