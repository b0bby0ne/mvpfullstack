...
## Script
- `TradingTeam/tools/scan_vn_1d_swing_setups.py`

## Lệnh chạy
```powershell
python TradingTeam\tools\scan_vn_1d_swing_setups.py
```

## Dữ liệu đầu vào
- Các file log JSONL từ Agent 1: `TradingTeam/agents/Agent_1_PriceAgent/Logs/vn_stock/*.jsonl`

## Đầu ra
- Summary:
  - `TradingTeam/agents/Agent_2_SwingAgent/Logs/latest_vn_stock_1d_scan_summary.json`
